...
public class AfterSplash2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttn2 = (Button) findViewById(R.id.button3);
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.track2);
    ...
    Button.OnClickListener bttn2L = new Button.OnClickListener()
    {
        @Override
        public void onClick(View view) {
            startActivity(new Intent(AfterSplash2.this,MainActivity.class));
